...
// This is an alternative way where we can enforce the type of
// app being passed into the function ... and only this would be exported.
// Renamed to ^above and above would be called something else.

// export function AppWithRepoMixin(app: Class<Application>) {
//  return MixinBuilder.mix(app).with(RepositoryMixin);
// }
